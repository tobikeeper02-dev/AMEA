...
def main() -> None:
    ...
    st.markdown(
        "This rewrite removes all cached data. Each run sends your engagement details directly to ChatGPT for tailored insights."
    )
    ...
    if st.button("Run analysis"):
        if not _parse_markets(markets_raw):

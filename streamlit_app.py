"""Minimal Streamlit interface for AMEA."""
...
from amea.pipeline import AnalysisResult, generate_analysis  # noqa: E402
from amea.research.llm import (  # noqa: E402
    ChatGPTConfig,
...
def _render_status(config: ChatGPTConfig) -> None:
    if is_chatgpt_configured(config):
        ...
        st.warning("No OpenAI API key found. Add one to run analyses.")
...
def main() -> None:
    ...
    st.markdown(
        "This rebuild keeps things simple: every analysis call goes straight to ChatGPT. "
        "Nothing is cached or prewritten. Provide your OpenAI key to continue."
    )
